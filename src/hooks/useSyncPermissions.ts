...
// snapshot until logout/login. On shell mount and route changes this hook
// re-reads the current user, writes the fresh permissions to
...
// persistent shell keeps its sidebar mounted; this reuse window avoids
// a verify-token round trip for every rapid navigation.
//
