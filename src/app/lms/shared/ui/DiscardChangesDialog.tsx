...
export function DiscardChangesDialog({
    ...
    onConfirm: () => void
    onCancel: () => void
    /** Forwarded to the kit Modal. Left undefined by default so every existing
     *  caller keeps click-outside-to-dismiss; the client console passes false
     *  so this dialog refuses the overlay click like the wizard behind it. */
