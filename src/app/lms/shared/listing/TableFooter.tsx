...
export default function TableFooter({
    ...
    return (
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 px-4 sm:px-5 py-1.5">
            ...
            {isLoading ? (
                <div role="status" aria-label="Loading results" className="inline-flex items-center">
                    <span className="sr-only">Loading results…</span>
                    <span aria-hidden="true" className="h-3 w-32 animate-pulse rounded bg-ink-100" />
                </div>
            ) : showCount && (
            ...
            {!showCount && !isLoading && <span aria-hidden="true" />}
