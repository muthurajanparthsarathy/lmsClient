  ...
  const handleSaveCurrentQuestion = useCallback(async (goNext: boolean, finishAfter = false) => {
    ...
    try {
      ...
      const payload = {
        ...
        // Provenance tag — Others questions don't have bank/AI ingresses so the
        // trainer always builds them manually. Persisted for parity with other
        // question types so the manage-questions source badge lights up.
        source: (currentBlock as any).source || 'scratch-manual',
