    ...
    <div className="flex flex-col h-full min-h-0" style={{ background: "#0f172a", fontFamily: "ui-monospace, SFMono-Regular, monospace" }}>
      ...
      <div className="flex items-center justify-between px-3 py-1.5 flex-shrink-0 border-b" style={{ borderColor: "#1e293b" }}>
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-wide text-gray-300">Terminal</span>
          {running && <span className="text-[10px] text-amber-300 animate-pulse">running…</span>}
        </div>
        <div className="flex items-center gap-3">
          {lastRuntimeMs != null && (
            <span className="flex items-center gap-1 text-[10px] text-gray-400"><Clock size={11} /> {lastRuntimeMs} ms</span>
          )}
      ...
      {/* Output */}
      <div ref={scrollRef} className="flex-1 overflow-auto px-3 py-2 text-[12px] leading-relaxed">
        {lines.length === 0 ? (
      ...
      {interactive && (
        <div className="flex-shrink-0 border-t px-3 py-2" style={{ borderColor: "#1e293b" }}>
          ...
          >
            <span className="text-[12px] flex-shrink-0" style={{ color: awaitingInput ? "#fbbf24" : "#64748b", fontFamily: "ui-monospace, monospace" }}>
