...
import { AlertCircle, Check, ChevronDown, Info, Lock } from 'lucide-react';
import { D } from '../../../pages/courses/uploadcourseresources/components/youdo/assessments/shared/tokens';
import { InfoTooltip, OInput, ONumberInput } from '../../../pages/courses/uploadcourseresources/components/youdo/assessments/shared/UIComponents';
...
export const ExerciseDetailsStep: React.FC<ExerciseDetailsStepProps> = ({
  ...
  return (
    ...
    <div style={{ padding: '16px 32px 24px', maxWidth: 1200 }}>
      ...
      {/* Skills — read-only chips built from the topic-configured languages.
          The set is owned by Topic Settings, so there is nothing to add or
          remove here; the chips just report what the topic is configured with. */}
