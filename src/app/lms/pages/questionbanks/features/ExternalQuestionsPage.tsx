...
import MCQFields from '@/app/lms/pages/questionbanks/components/MCQFields';
import CreateQuestionModal from '@/app/lms/pages/questionbanks/components/create/CreateQuestionModal';
...
} from '@/app/lms/pages/questionbanks/queries/questionBank';
