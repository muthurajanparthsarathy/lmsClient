...
import { ClientAvatar, formatServiceModel, type MappingRowVM } from "./workspaceShared";
import { MODEL_TONES, businessModelDisplayName } from "@/app/lms/pages/clientmanagement/features/lib";
                  ...
                  <td className="px-3 h-[64px] align-middle">
                    {vm.businessModel ? (
                      <span
                        ...
                        title={businessModelDisplayName(vm.businessModel)}
                      >
                        {businessModelDisplayName(vm.businessModel)}
                      </span>
                    ) : (
                  ...
                  <td className="px-3 h-[64px] align-middle">
                    {vm.models.length === 0 ? (
                      ...
                      <span
                        ...
                        title={vm.models.map((m) => formatServiceModel(m, vm.service)).join(', ')}
                      >
