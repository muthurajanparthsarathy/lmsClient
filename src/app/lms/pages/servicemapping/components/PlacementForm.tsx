...
export default function PlacementForm({
    ...
    // `useSections` is used purely as the open/closed store here: it derives its
    // own state from the id set it was seeded with, which cannot know how many
    // phases exist right now.
    //
