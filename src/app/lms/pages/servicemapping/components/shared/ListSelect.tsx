...
export type ListSelectOption = {
    ...
    disabled?: boolean
    /**
     * A muted second line under the label — "Business to Institution" under
     * "B2I". Open list only: the trigger shows the label alone.
     */
    description?: string
}
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span className="min-w-0 flex-1">
                                                        ...
                                                        {option.description && (
                                                            <span className="block truncate text-xs">{option.description}</span>
                                                        )}
                                                    </span>
                                                </div>
                                            )
