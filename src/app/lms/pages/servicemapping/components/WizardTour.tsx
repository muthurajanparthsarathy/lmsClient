...
const BEATS_BY_WIZARD_STEP: Record<number, TourBeat[]> = {
    0: [
        ...
        // Same order as the Step 1 grid: Business model · Client, then
        // Service model · Service offering year.
        {
            ...
            text: 'Pick B2B, B2I or B2C. The client list beside it then shows only clients with that business model, and the service models follow it too.',
        },
        {
            id: 'sm-client',
            anchor: 'sm-client',
            on: 'bottom-start',
            title: 'Then the client',
            text: 'Pick the college or company this mapping belongs to — only clients with the chosen business model are listed. Everything you fill in after this is scoped to them.',
        },
        {
            id: 'sm-model',
            anchor: 'sm-model',
        ...
        },
        {
            ...
            anchor: 'sm-year',
            on: 'bottom-start',
            title: 'Service offering date & year',
            text: 'Set to today\'s date automatically, so there is nothing to pick. Its year is also used to suggest sensible batch names later on.',
        },
        {
            id: 'sm-partner',
            anchor: 'sm-partner',
    ...
    1: [
        ...
        },
        {
            ...
            text: 'Pick the courses taught in this semester — one row per course. The list holds every course in Course Management, whatever category it sits under, so search it rather than scroll it.',
        },
        {
        ...
        },
        {
            ...
            text: 'Tick Phase configuration when this training runs in stages, then type how many. With it off, the mapping carries its courses directly.',
        },
        {
            id: 'sm-prt-courses',
            anchor: 'sm-prt-courses',
            on: 'top',
            title: 'One course per phase',
            text: 'Each phase carries exactly one course — pick it from the list, which offers the courses already set up under this service. Tick Batches to say how many groups sit that course, then name each one.',
        },
        {
            id: 'sm-save',
            anchor: 'sm-save',
