...
import { useIsPreviewingAsStudent } from "../courses/coursesdetailedview/components/useAccountMenu";
...
import { fetchAllPedagogyViews } from "@/app/lms/pages/coursestructure/pedagogy2/api/pedagogy";
...
const AttendanceReportPage = dynamic(
  () => import("@/app/lms/pages/attendancemanagement/features/AttendanceReportPage"),
  { ssr: false, loading: () => <Loading /> },
);
