...
} from '@/app/lms/pages/external/assessment/api/externalAssessment';
import { setExternalAssessmentContext, toLmsQuestionShape } from '@/app/lms/pages/external/assessment/api/externalQuestionAdapter';
...
import type { ExternalQuestionOrigin } from '@/app/lms/pages/external/assessment/api/externalAssessment';
