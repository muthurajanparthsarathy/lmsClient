...
import type { ExternalAssessment, ExternalQuestion } from '@/app/lms/pages/external/assessment/api/externalAssessment';
import { EXTERNAL_ENTITY, toLmsQuestionShape } from '@/app/lms/pages/external/assessment/api/externalQuestionAdapter';
