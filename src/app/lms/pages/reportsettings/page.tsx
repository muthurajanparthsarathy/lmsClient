...
export default function ReportSettingsPage() {
    ...
    /* Every element the canvas has selected. Ctrl / Cmd-click builds a
     * multi-selection so several pieces can be dragged together; the
     * property panel below edits the FIRST of them. */
                        ...
                        <div className="mt-3 grid min-h-0 flex-1 gap-3 xl:grid-cols-[minmax(0,1fr)_268px]">
                            <div className="flex min-h-0 min-w-0 flex-col gap-2">
                                ...
                                <div className="min-h-[340px] flex-1">
                                    <ReportCanvas format={active} selectedIds={selectedIds} onSelect={setSelectedIds} onChange={patchElement} />
                                </div>
                            </div>
