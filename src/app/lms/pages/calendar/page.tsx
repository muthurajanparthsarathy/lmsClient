...
import { institutionApi } from '@/app/lms/pages/instutionmanagement/api/institutionService'
import { instituteHolidayCalendarApi, type HolidayPayload } from '@/app/lms/pages/calendar/api/instituteHolidayCalendarApi'
