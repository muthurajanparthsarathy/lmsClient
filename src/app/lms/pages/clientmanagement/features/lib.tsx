...
export type ClientSortKey = 'company' | 'model' | 'status' | 'serial' | 'contactName' | 'email' | 'contactNumber' | 'createdAt'
...
export const businessModelDisplayName = (value?: string): string => {
    ...
    return model ? `${businessModelFullName(model.value)} (${model.value})` : value?.trim() || '—'
}
