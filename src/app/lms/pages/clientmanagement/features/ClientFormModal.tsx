    ...
    return (
        <>
            <Modal
                ...
                size="xl"
                // A stray click on the overlay would throw away a part-filled
                // two-step form, so it blinks the dialog instead of closing.
                // Escape and Cancel still route through guardedClose, which is
                // where the discard confirmation lives.
