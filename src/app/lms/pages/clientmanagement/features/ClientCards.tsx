...
import {
    MODEL_TONES, TYPE_LABEL, avatarTone, businessModelDisplayName,
...
// The card's identifier chip. Prefers the server-allocated Client ID
// (e.g. "CLT-000023") — stable, readable, matches the list column —
// and falls back to a Mongo-id-derived slug only for legacy rows that
// haven't been backfilled yet.
const clientCode = (client: Client) =>
    client.clientId
        ? client.clientId
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-semibold text-faint tabular-nums flex-shrink-0">{clientCode(client)}</span>
                    </div>
