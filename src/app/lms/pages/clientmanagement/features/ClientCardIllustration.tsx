type IllustrationKind = 'clients' | 'business' | 'institution' | 'consumer'
...
export default function ClientCardIllustration({ kind }: { kind: IllustrationKind }) {
    return (
        <svg aria-hidden="true" focusable="false" viewBox="0 0 180 100" fill="none" className="h-full w-full">
            ...
            {kind === 'consumer' && <>
                <path d="M70 42h70l-4 44a6 6 0 0 1-6 5H80a6 6 0 0 1-6-5l-4-44Z" fill="white" stroke="currentColor" strokeOpacity=".3" strokeLinejoin="round" />
                <path d="M88 48V36a17 17 0 0 1 34 0v12" stroke="currentColor" strokeOpacity=".35" strokeWidth="3" fill="none" strokeLinecap="round" />
                <circle cx="88" cy="54" r="3" fill="currentColor" opacity=".35" />
                <circle cx="122" cy="54" r="3" fill="currentColor" opacity=".35" />
                <path d="M78 62h54" stroke="currentColor" strokeOpacity=".18" strokeWidth="2" strokeLinecap="round" />
                <path d="M82 72h46" stroke="currentColor" strokeOpacity=".14" strokeWidth="2" strokeLinecap="round" />
                <circle cx="150" cy="76" r="9" fill="currentColor" opacity=".16" />
                <path d="M146 76h8m-4-4v8" stroke="currentColor" strokeOpacity=".55" strokeWidth="2" strokeLinecap="round" />
            </>}
        </svg>
    )
}
