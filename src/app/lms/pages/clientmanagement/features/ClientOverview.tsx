...
export default function ClientOverview({ counts, isError }: {
    ...
    const cards = [
        ...
        { label: 'B2C clients', short: 'B2C clients', value: counts?.b2c, icon: ShoppingBag, color: 'bg-emerald-50 text-emerald-600', art: 'consumer', tint: '#e6f7f0', ink: 'text-emerald-600' },
    ] as const

    return (
        <dl aria-label="Client overview" className="grid shrink-0 grid-cols-2 gap-2 sm:grid-cols-4 sm:gap-3">
