...
export interface Course {
    ...
    _id: string
    courseName: string
    /** The mapping this course was set up from, and where it sits in it — a
     *  phase name for placement training, "" for the flat flows. Both come back
     *  from the course endpoints; declared optional because a legacy record
     *  saved before mappings were tracked has neither. */
    mappingId?: string
    coursePath?: string
