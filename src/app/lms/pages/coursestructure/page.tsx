...
import { useServiceMapping, serviceMappingKeys, type ServiceMapping } from '@/app/lms/pages/servicemapping/api/serviceMappingService'
...
export default function CourseStructurePage() {
    ...
    useEffect(() => {
        ...
        setStage({ name: 'hierarchy', mapping: deepLinkMapping, openActionsForCourseId: openCourseId })
