...
import { ArrowLeft, BookOpen, Building2, CalendarDays, Check, ChevronRight, CircleAlert, CircleCheck, Code2, GraduationCap, Layers, Network, Plus, Settings2, Table2, UploadCloud, UsersRound } from 'lucide-react'
            ...
            {groups.length === 0 ? (
                ...
                <div className="bg-surface rounded-xl border border-hairline shadow-xs px-4 sm:px-5 py-4 space-y-0.5">
                    ...
                    {phaseCourses.map((entry) => {
                        ...
                        return (
                            <div key={entry.name} className="rounded-xl">
                                <CourseRow course={primary} />
                                <div className="ml-[18px] border-l border-hairline pl-4 pb-1">
