...
import FileMCQAnnotationForm from "../../../component/FileMCQAnnotationForm"
import {
...
function MCQQuestionForm({
  ...
  apiBaseUrl = `${API_ORIGIN}`, mcqMode = "default", sampleLink = "",
  onLinkGenerated,
}: any) {
...
export default function PPTViewer({
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const res = await fetch(`${API_ORIGIN}/api/ppt/convert`, {
          method: "POST",
