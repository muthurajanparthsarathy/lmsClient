...
import { Question } from '@/app/lms/pages/courses/components/QuestionsView';
import { PROBLEM_TYPES } from '@/app/lms/pages/questionbanks/components/create/createShared';
