...
import { useAttemptSession } from '@/app/lms/pages/courses/coursesdetailedview/components/YouDo/useAttemptSession';
import ConnectionStatusBanner from "../../components/YouDo/ConnectionStatusBanner";
