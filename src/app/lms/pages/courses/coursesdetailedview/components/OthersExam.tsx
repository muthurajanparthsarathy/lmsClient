...
import { useAttemptSession } from "./YouDo/useAttemptSession";
...
import OthersNotionEditor, { PageData } from '../../reviewSubmission/components/OthersNotionEditor';
import ExerciseInfoModals, { ExerciseInfoButtons } from './ExerciseInfoModals';
import toast from 'react-hot-toast';
import ConnectionStatusBanner from "./YouDo/ConnectionStatusBanner";
...
const FileUploadAnswerArea: React.FC<{
  ...
  const doUpload = async (file: File): Promise<string | null> => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await fetch(`${API_ORIGIN}/upload/question-file`, {
